...
RSpec.describe CommonSteps::PiecesController, type: :controller do
    ...
    it "retrieves pieces information for a cargo info" do
    	piece = CommonSteps::Piece.create(fcl_exw_steps_cargo_info_id: cargo_info.id, gross_weight: 123, commercial_description: "some commercial description")
