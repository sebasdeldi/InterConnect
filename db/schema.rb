...
ActiveRecord::Schema.define(version: 20210927200628) do
  ...
  create_table "fcl_exw_steps_info_requesteds", force: :cascade do |t|
    t.boolean "completed", default: false
    t.bigint "operation_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["operation_id"], name: "index_fcl_exw_steps_info_requesteds_on_operation_id"
  end

  create_table "fcl_exw_steps_quotation_confirmeds", force: :cascade do |t|
    t.boolean "completed", default: false
    t.bigint "operation_id"
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.string "subject"
    t.date "due_date"
    t.bigint "fcl_exw_steps_info_requested_id"
