...
document.addEventListener("turbolinks:load", function() {
	...
	var addFields = (fields_number, data, modality) => {
	  ...
	  if ( data === undefined || data.length == 0){
	  	for (i=0; i < fields_number; i++){
	  	  ...
	  	  }else if(modality == 'lcl'){
					weight_field.innerHTML = ("<div class='box card-shadow margin-bottom'><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Gross Weight (lbs)</label><div class='control has-icons-left'><input class='input' name='weight-" + (i + 1) + "'" + "><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Length (lbs)</label><div class='control has-icons-left'><input class='input' name='length-" + (i + 1) + "'" + "><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Width (lbs)</label><div class='control has-icons-left'><input class='input' name='width-" + (i + 1) + "'" + "><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Height (lbs)</label><div class='control has-icons-left'><input class='input' name='height-" + (i + 1) + "'" + "><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Commercial Description</label><div class='control has-icons-left'><input class='input' name='commercial-description-" + (i + 1) + "'" + "><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal commercial-description'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field container_type full-select'><label class='label'>Piece # " + (i+1) + " Piece Type</label><div class='control'><div class='select full-select'><select class='full-select' name='container-type-" + (i + 1) + "'" + "><option>Box</option><option>Crate</option><option>Pallet</option></select></div></div></div></div><div class='column is-1'><br><a class='show-modal container-type'><i class='fas fa-info-circle guide-btn'></i></a></div></div><br><div class='columns'><div class='column is-11'><div class='field cargo_hazardous full-select'><label class='label'>Is Cargo # " + (i+1) + " Hazardous?</label><div class='control'><div class='select full-select'><select class='full-select hazardous-select' name='is-hazardous" + (i + 1) + "'" + "><option>NO</option><option>YES</option></select></div></div></br></div></div><div class='column is-1'><br><a class='show-modal is-hazard'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns hidden'><div class='column is-11'><div class='field'><label class='label'>Container # " + (i+1) + " Hazard Class</label><div class='control has-icons-left'><input class='input' name='hazard-class-" + (i + 1) + "'" + "><span class='icon is-small is-left'><i class='fas fa-exclamation-triangle'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal hazard-class'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns hidden'><div class='column is-11'><div class='field'><label class='label'>Container # " + (i+1) + " Un-Code</label><div class='control has-icons-left'><input class='input' name='un-code-" + (i + 1) + "'" + "><span class='icon is-small is-left'><i class='fas fa-exclamation-triangle'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal un-code'><i class='fas fa-info-circle guide-btn'></i></a></div></div></div></div><br>")
	  	  }
	  	...
	  	for (i=0; i < fields_number; i++){
	  	  ...
	  	  if(modality == 'fcl-exw'){
	  	  	weight_field.innerHTML = ("<div class='box card-shadow margin-bottom'><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Container # " + (i+1) + " Gross Weight (lbs)</label><div class='control has-icons-left'><input class='input' name='weight-" + (i + 1) + "' value='" + data[i].gross_weight + "'" +"><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Container # " + (i+1) + " Commercial Description</label><div class='control has-icons-left'><input class='input' name='commercial-description-" + (i + 1) + "'" + "' value='" + data[i].commercial_description + "'" + "><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal commercial-description'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field container_type full-select'><label class='label'>Piece # " + (i+1) + " Container Type</label><div class='control'><div class='select full-select'><select class='full-select container-type-" +i+"'"+" name='container-type-" + (i + 1) + "'"  + "><option>20'</option><option>40'</option><option>40' HC</option><option>45'</option><option>45' HC</option><option>20' NOR</option><option>40' NOR</option><option>20' Flat Rack</option><option>40' Flat Rack</option><option>20' Open Top</option><option>40' Open Top</option></select></div></div></div></div><div class='column is-1'><br><a class='show-modal container-type'><i class='fas fa-info-circle guide-btn'></i></a></div></div><br><div class='columns'><div class='column is-11'><div class='field cargo_hazardous full-select'><label class='label'>Is Cargo # " + (i+1) + " Hazardous?</label><div class='control'><div class='select full-select'><select class='full-select hazardous-select cargo-hazardous-"+i +"'"+" name='is-hazardous" + (i + 1) + "'" + "><option>NO</option><option>YES</option></select></div></div></br></div></div><div class='column is-1'><br><a class='show-modal is-hazard'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns hidden'><div class='column is-11'><div class='field'><label class='label'>Container # " + (i+1) + " Hazard Class</label><div class='control has-icons-left'><input class='input' name='hazard-class-" + (i + 1) + "'" + "' value='" + data[i].hazardous_class + "'" + "><span class='icon is-small is-left'><i class='fas fa-exclamation-triangle'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal hazard-class'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns hidden'><div class='column is-11'><div class='field'><label class='label'>Container # " + (i+1) + " Un-Code</label><div class='control has-icons-left'><input class='input' name='un-code-" + (i + 1) + "'" + "' value='" + data[i].un_code + "'" +"><span class='icon is-small is-left'><i class='fas fa-exclamation-triangle'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal un-code'><i class='fas fa-info-circle guide-btn'></i></a></div></div></div></div><br>");
					...
					weight_field.innerHTML = ("<div class='box card-shadow margin-bottom'><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Gross Weight (lbs)</label><div class='control has-icons-left'><input class='input' name='weight-" + (i + 1) + "' value='" + data[i].gross_weight + "'" +"><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Length (lbs)</label><div class='control has-icons-left'><input class='input' name='length-" + (i + 1) + "' value='" + data[i].length + "'" +"><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Width (lbs)</label><div class='control has-icons-left'><input class='input' name='width-" + (i + 1) + "' value='" + data[i].width + "'" +"><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Height (lbs)</label><div class='control has-icons-left'><input class='input' name='height-" + (i + 1) + "' value='" + data[i].height + "'" +"><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal gross-weight'><i class='fas fa-info-circle guide-btn gross-weight'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Commercial Description</label><div class='control has-icons-left'><input class='input' name='commercial-description-" + (i + 1) + "'" + "' value='" + data[i].commercial_description + "'" + "><span class='icon is-small is-left'><i class='fas fa-weight'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal commercial-description'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns'><div class='column is-11'><div class='field container_type full-select'><label class='label'>Piece # " + (i+1) + " Container Type</label><div class='control'><div class='select full-select'><select class='full-select container-type-" +i+"'"+" name='container-type-" + (i + 1) + "'"  + "><option>Box</option><option>Crate</option><option>Pallet</option></select></div></div></div></div><div class='column is-1'><br><a class='show-modal container-type'><i class='fas fa-info-circle guide-btn'></i></a></div></div><br><div class='columns'><div class='column is-11'><div class='field cargo_hazardous full-select'><label class='label'>Is Cargo # " + (i+1) + " Hazardous?</label><div class='control'><div class='select full-select'><select class='full-select hazardous-select cargo-hazardous-"+i +"'"+" name='is-hazardous" + (i + 1) + "'" + "><option>NO</option><option>YES</option></select></div></div></br></div></div><div class='column is-1'><br><a class='show-modal is-hazard'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns hidden'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Hazard Class</label><div class='control has-icons-left'><input class='input' name='hazard-class-" + (i + 1) + "'" + "' value='" + data[i].hazardous_class + "'" + "><span class='icon is-small is-left'><i class='fas fa-exclamation-triangle'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal hazard-class'><i class='fas fa-info-circle guide-btn'></i></a></div></div><div class='columns hidden'><div class='column is-11'><div class='field'><label class='label'>Piece # " + (i+1) + " Un-Code</label><div class='control has-icons-left'><input class='input' name='un-code-" + (i + 1) + "'" + "' value='" + data[i].un_code + "'" +"><span class='icon is-small is-left'><i class='fas fa-exclamation-triangle'></i></span></div></div></div><div class='column is-1'><br><a class='show-modal un-code'><i class='fas fa-info-circle guide-btn'></i></a></div></div></div></div><br>")
	  	  }
	  	  container.appendChild(weight_field);
	  ...
	  hideHazFieldsWhenSaved(modality);
	}

	function hideHazFieldsWhenSaved(modality){
		if($('#container')[0] !== undefined){
		  for (i=0; i < $('#container')[0].childNodes.length; i++) {
	  	  if(modality == 'fcl-exw'){
	  	  	...
	  	  	haz = $('#container')[0].children[i].children[0].children[7].children[0].children[0].children[1].children[0].children[0];
	  	  }
	  	  console.log(haz)
		  	if(haz.value === "YES"){
	...
	$('.pieces-number-diff').on("change keydown paste input", () => {
		addFields($('.input.pieces-number-diff').val(), [], $('.input.pieces-number-diff')[0].classList[2]);
	});

	if (container !== null ){
		$.ajax({
		  type: "POST",
		  url: "/common_steps/pieces",
		  data: { fcl_exw_steps_cargo_info_id: $('.fcl_exw_steps_cargo_info_id').val() },
		  success: function(data){

		  	if(data[data.length-1] === 'update'){
		  		addFields($('.input.pieces-number-diff').val(), data, $('.input.pieces-number-diff')[0].classList[2]);
		  	}else{
