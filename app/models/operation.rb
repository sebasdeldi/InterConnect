class Operation < ApplicationRecord
	...
	def fetch_operations (sort_param ,modality_param=nil, status_param=nil, search_param=nil, current_user)
		...
		operations = query_operations(set_operations(current_user), sort_param ,modality_param, status_param, search_param, current_user)
