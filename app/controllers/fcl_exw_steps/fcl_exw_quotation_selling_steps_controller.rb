  ...
  class FclExwQuotationSellingStepsController < ApplicationController
    def confirm
      if params[:commit] == "REQUEST"
        ...
        quotation = FclExwSteps::FclExwQuotationSellingStep.find_by(operation_id: params[:operation_id])
        operation = Operation.find(params[:operation_id])
    ...
    def show
    	...
    	@quotation = FclExwSteps::FclExwQuotationSellingStep.find_by(operation_id: params[:id])
