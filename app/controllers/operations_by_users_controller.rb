	...
	private
		...
		def representative_operation_creation(last_digits)
			if params[:operations_by_user][:agent_id].present? && params[:operations_by_user][:shipper_id].present?
				...
				fields = [ reference, params[:modality], strong_params_for_representatives, current_user, params[:pieces_number], params[:po_number], params[:agent_reference], params[:shipper_reference],
				params[:consignee_reference],	params[:pol], params[:pod], params[:origin], params[:destination] ]
