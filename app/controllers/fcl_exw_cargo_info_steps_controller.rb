class FclExwCargoInfoStepsController < ApplicationController
	...
	private
		...
		def fcl_cargo_info_params
			params.require(:fcl_exw_cargo_info_step).permit(:operation_id, :loading_address, :loading_date, :loading_time, :gross_weight, :commercial_description, :cargo_hazardous, :hazardous_document,
